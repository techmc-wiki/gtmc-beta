...
This project is indexed by GitNexus as **gtmc** (4577 symbols, 10346 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
