  ...
  return (
    <SkeletonExitWrapper>
      <div
        ...
        {/* FEATURE_HEADER_ */}
        <div className="animate-tech-slide-in motion-reduce:animate-none relative flex flex-col gap-4">
          <ScanConfirmOverlay />
          <div>
        ...
        {/* ISSUE_METADATA_ */}
        <TechCard className="animate-tech-slide-in motion-reduce:animate-none [animation-delay:100ms]">
        ...
        {/* RESOLUTION_BLOCK_ */}
        <TechCard className="animate-tech-slide-in motion-reduce:animate-none border-tech-accent/40 bg-tech-accent/5 relative overflow-hidden backdrop-blur-sm [animation-delay:200ms]">
        ...
        {/* EDITOR_BUFFER_ */}
        <div className="group animate-tech-slide-in motion-reduce:animate-none border-tech-main relative flex w-full flex-col space-y-6 border bg-white/80 p-4 backdrop-blur-sm [animation-delay:300ms] sm:p-6">
        ...
        {/* DISCUSSION_LOG_ */}
        <div className="animate-tech-slide-in motion-reduce:animate-none space-y-6 [animation-delay:400ms]">
