  ...
  return (
    <SkeletonExitWrapper>
      <div
        ...
        {/* FEATURE_HEADER_ */}
        <div className="animate-tech-slide-in relative flex flex-col gap-4 motion-reduce:animate-none">
          <ScanConfirmOverlay />
          <div>
        ...
        {/* ISSUE_METADATA_ */}
        <TechCard className="animate-tech-slide-in [animation-delay:100ms] motion-reduce:animate-none">
        ...
        {/* RESOLUTION_BLOCK_ */}
        <TechCard className="animate-tech-slide-in border-tech-accent/40 bg-tech-accent/5 relative overflow-hidden backdrop-blur-sm [animation-delay:200ms] motion-reduce:animate-none">
        ...
        {/* EDITOR_BUFFER_ */}
        <div className="group animate-tech-slide-in border-tech-main relative flex w-full flex-col space-y-6 border bg-white/80 p-4 backdrop-blur-sm [animation-delay:300ms] motion-reduce:animate-none sm:p-6">
        ...
        {/* DISCUSSION_LOG_ */}
        <div className="animate-tech-slide-in space-y-6 [animation-delay:400ms] motion-reduce:animate-none">
